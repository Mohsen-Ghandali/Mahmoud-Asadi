  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="container-app pointer-events-none relative z-20 h-full w-full">
          {badgeRing.length > 0 && (
            <div className="pointer-events-auto absolute end-5 top-1/2 hidden -translate-y-1/2 sm:block">
          ...
          <div className="pointer-events-auto absolute inset-x-5 bottom-14 flex justify-start sm:bottom-20">
